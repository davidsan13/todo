...
function Inbox() {
  ...
  console.log(keys)
  if (keys.length === 0) {
    return (0,_dom__WEBPACK_IMPORTED_MODULE_1__.rightContainer)(project);
  }
  keys.forEach((key) => {
